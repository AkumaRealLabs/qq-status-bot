    ...
    <section className="grid min-w-0 gap-4">
      ...
      {configured && <>
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
          ...
          <Metric label="会话级失败" value={sessionFailures} />
        </div>
